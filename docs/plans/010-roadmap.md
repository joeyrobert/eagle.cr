...
## Log
- 2026-09-18: v0.2.0: installers and `eagle init`, spatial 3D audio, checkers AI/UX, Joyride, Neon Bastion FPS, algorithms library, voxel island, Physics3D capsules/meshes/joints, UI scroll containers/drop-downs/rich text, touch input and gestures, batched text and shapes, the GL crash fix, CI, site breadcrumbs.
